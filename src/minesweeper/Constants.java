...
public final class Constants {
    ...
    public static double FIELD_START_WIDTH = Constants.COLUMNS * Constants.CELL_START_SIZE + (Constants.COLUMNS) + GAME_BOUNDARY_SIZE * 2;
    public static double FIELD_START_HEIGHT = Constants.ROWS * Constants.CELL_START_SIZE + (Constants.ROWS) + GAME_BOUNDARY_SIZE * 2;
